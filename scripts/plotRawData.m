...
filename = "/tmp/SonarRawData_000003.csv";
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bw = 29.9e3; % bandwidth
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Constant azimuth (center-line)
% gain = 1;
% plotData = 20*log10(abs(Data(:,256))*gain + 1);
% 
% figure;plot(range_vector, 20*log10(plotData)-min(20*log10(plotData(10:80))) ...
%      ); grid on;
%  
%  ylim([0 40]);
...
figure;plot(range_vector, 20*log10(plotData) ...
     ); grid on;
